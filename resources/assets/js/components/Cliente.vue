<template>
  <main class="main">
    ...
    <ImportarExcelCliente v-if="mostrarDialogoImportar" :visible.sync="mostrarDialogoImportar"
...
import ImportarExcelCliente from "./productos/ImportarExcelClientes.vue";
...
export default {
  ...
  methods: {
    ...
    async buscarDireccion() {
      ...
      this.debounceDireccion = setTimeout(async () => {
        ...
        if (!this.datosFormulario.direccion.trim()) {
        ...
        try {
          const response = await axios.get(
            `/cliente/buscarDireccion?filtro=${this.datosFormulario.direccion}`
          );
  ...
  seleccionarDireccionEnter() {
    ...
    seleccionarDireccion(dir) {
      this.datosFormulario.direccion = dir;
      this.mostrarDesplegableDireccion = false;
      console.log("Dirección seleccionada:", this.datosFormulario.direccion);
    },
    closeDialog() {
